...
import logoBpsdmi from '@/images/logos/bpsdmi-logo.jpg'

export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Integrasikan bisnis Anda dengan{' '}
        <span className="relative whitespace-nowrap text-green-600">
          ...
          <span className="relative">MT WA API.</span>
        </span>{' '}
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="https://tally.so/r/wkyOBe">Daftar Sekarang</Button>
      </div>
